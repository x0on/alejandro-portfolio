...
import { ASSETS, hero, about, featuredFilm, book, pressArticles, interviews, socialLinks, contact, experience, clients, filmography } from "@/data/content";
import { useState } from "react";
import { motion } from "framer-motion";
import {
  ExternalLink, Download, ChevronDown, ChevronUp, Play,
  Award, Calendar, Clock, Globe, Film, BookOpen, Mail, Phone,
  MapPin, Quote, Star, Clapperboard, Copy, Check
} from "lucide-react";
      ...
      <main className="lg:ml-56 pt-14">
          ...
          <div className="relative container py-20 md:py-32">
            <div className="max-w-3xl">
              ...
              >
                ...
                <p className="text-base md:text-lg text-muted-foreground mt-4 tracking-wide">
                  {hero.title}
                </p>
              ...
              >
                ...
                <a
                  href="#press"
                  className="px-5 py-2.5 text-sm border border-border text-foreground rounded-sm hover:bg-secondary transition-colors font-medium"
                >
                  View Press
                </a>
                <a
        ...
        <Section id="film" className="relative">
          ...
          <div className="relative container py-16 md:py-24">
            <SectionTitle number="02" title="Featured Film" subtitle="Latest Award-Winning Work" />
            <div className="grid md:grid-cols-5 gap-10">
              <div className="md:col-span-3 space-y-5">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">{featuredFilm.subtitle} ({featuredFilm.year})</p>
                </div>
                <p className="text-sm leading-relaxed">{featuredFilm.description}</p>
                <blockquote className="border-l-2 border-primary pl-4 italic text-muted-foreground text-sm leading-relaxed">
                  "{featuredFilm.directorStatement}"
                  <span className="block mt-1 not-italic font-mono text-xs">— Director's Statement</span>
                </blockquote>

                <div className="flex flex-wrap gap-4 text-xs font-mono text-muted-foreground">
                  <span className="flex items-center gap-1"><Clock size={12} /> {featuredFilm.runtime}</span>
                  <span className="flex items-center gap-1"><Globe size={12} /> {featuredFilm.language}</span>
                  <span className="flex items-center gap-1"><Film size={12} /> {featuredFilm.format}</span>
                </div>
                ...
                {featuredFilm.links.website && (
                  <a
                    href={featuredFilm.links.website}
                    target="_blank"
        ...
        <Section id="book" className="container py-16 md:py-24">
          <SectionTitle number="03" title="Book" subtitle="Published Work" />
        ...
        <Section id="press" className="relative">
          ...
          <div className="relative container py-16 md:py-24">
            <SectionTitle number="04" title="Press Coverage" subtitle="Media Features & Reviews" />
            <div className="space-y-4">
        ...
        <Section id="interviews" className="container py-16 md:py-24">
          <SectionTitle number="05" title="Interviews & Media" subtitle="Video Content" />
          ...
          <div className="mt-12">
            <h3 className="text-sm font-mono uppercase tracking-wider text-muted-foreground mb-4 flex items-center gap-2">
              <Clapperboard size={14} /> Filmography
            </h3>
            <div className="border border-border rounded-sm overflow-hidden">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-border">
                  {(showAllFilmography ? filmography : filmography.slice(0, 4)).map((f, i) => (
        ...
        <Section id="experience" className="container py-16 md:py-24">
          <SectionTitle number="06" title="Experience" subtitle="Professional Background" />
        ...
        <Section id="social" className="relative">
          ...
          <div className="relative container py-16 md:py-24">
            <SectionTitle number="07" title="Connect" subtitle="Social Media & Contact" />
